...
const candidatosFlutter = [
  process.env.FLUTTER_BIN,
  'C:\\flutter\\src\\flutter\\bin\\flutter.bat',
  'C:\\Users\\Juanma\\flutter\\bin\\flutter.bat',
].filter(Boolean);
const flutter = candidatosFlutter.find((ruta) => existsSync(ruta)) ?? 'flutter';
